...
Usage: EDA_images_script.R --image_path=<path_to_save> " -> doc
##Exact usage from Milestone_4: Rscript scripts/EDA_images_script.R --image_path="images/"
...
main <- function(image_path) {
  ...
  print(glue("Data analysis for research questions is completed. Images are found in ", image_path))
